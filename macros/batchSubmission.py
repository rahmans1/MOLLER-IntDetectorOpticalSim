...
LightGuideLowerConeBackAngle = list(map(str, np.random.randint(1,45,size=1+int(x[index:])-int(x[:index-1]))))
LightGuideLowerConeFrontAngle = list(map(str, np.random.randint(1,45,size=1+int(x[index:])-int(x[:index-1]))))
LightGuideLowerInterface = list(map(str, np.random.randint(65,95,size=1+int(x[index:])-int(x[:index-1]))))
LightGuideUpperInterface = list(map(str, np.random.randint(611,621,size=1+int(x[index:])-int(x[:index-1]))))
LightGuidePMTInterfaceOpeningX = list(map(str, np.random.randint(70,70, size=1+int(x[index:])-int(x[:index-1]))))
LightGuidePMTInterfaceOpeningZ = list(map(str, np.random.randint(70,70, size=1+int(x[index:])-int(x[:index-1]))))
QuartzSizeZ = np.random.randint(10,30,size=1+int(x[index:])-int(x[:index-1]))
QuartzSizeX = np.random.randint(177,177,size=1+int(x[index:])-int(x[:index-1]))
QuartzSizeY = list(map(str, np.random.randint(60,60,size=1+int(x[index:])-int(x[:index-1]))))
...
QuartzBevelSize = list(map(str, np.random.randint(0.5,0.5,size=(1+int(x[index:])-int(x[:index-1])))))
QuartzRotX = list(map(str, np.random.randint(-3,-3,size=(1+int(x[index:])-int(x[:index-1])))))
PolarRotation = list(map(str, np.random.randint(3,3,size=(1+int(x[index:])-int(x[:index-1])))))
LightGuideQuartzToPMTOffset = list(map(str, np.random.randint(-10,10,size=(1+int(x[index:])-int(x[:index-1])))))
