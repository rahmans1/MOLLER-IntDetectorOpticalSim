...
jsubf.write("echo /Det/LightGuideLowerInterface ${LightGuideLowerInterface[${SLURM_ARRAY_TASK_ID}]} cm >>"+macro+"\n")
jsubf.write("echo /Det/LightGuideUpperInterface ${LightGuideUpperInterface[${SLURM_ARRAY_TASK_ID}]} mm >>"+macro+"\n")
jsubf.write("echo /Det/LightGuidePMTInterfaceOpeningX ${LightGuidePMTInterfaceOpeningX[${SLURM_ARRAY_TASK_ID}]} cm >>"+macro+"\n")
jsubf.write("echo /Det/LightGuidePMTInterfaceOpeningZ ${LightGuidePMTInterfaceOpeningZ[${SLURM_ARRAY_TASK_ID}]} cm >>"+macro+"\n")
jsubf.write("echo /Det/LightGuideQuartzInterfaceOpeningX ${LightGuideQuartzInterfaceOpeningX[${SLURM_ARRAY_TASK_ID}]} cm >>"+macro+"\n")
jsubf.write("echo /Det/LightGuideQuartzInterfaceOpeningZ ${LightGuideQuartzInterfaceOpeningZ[${SLURM_ARRAY_TASK_ID}]} cm >>"+macro+"\n")
